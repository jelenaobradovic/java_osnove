...
public class Kasa {
    ...
    //U mainu kreirati jednu kasu i u nju dodajte 3-4 proizvoda sa nekoliko
    // dodatak i stampajte racun.U mainu ne kreirate dodatke!!!! Koristite samo one koje vec ima kasa.
}
